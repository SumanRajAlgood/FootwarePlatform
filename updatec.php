...
<center><h2 style="color:darkgreen;">CUSTOMER INFORMATION STORAGE</h2></center>
...
echo "<script type='text/javascript'>alert('$msg');</script>";
    ...
    <h1 style="color:darkgreen;"><center>CUSTOMER UPDATION</center></h1>
    <form method="post">
 Enter the cid for updating<input type="text" name="cid" /> 
     <br><br>
Customer Name: <input type="text" name="cname" pattern="[A-Za-z]+" required /><br><br>
   ...
   $Caddress=$_POST['caddress'];
        ...
        $sql1="UPDATE footwear set  cname='$Cname',cphone='$Cphone',cemail='$Cemail',caddress='$Caddress' where cid='$Cid' ";
...
$msg="1 record updated";
    ...
    <h1 style="color:darkgreen;"><center>CUSTOMER DELETION</center></h1>
    <form method="post">
        Enter the cid for deleting<input type="text" name="dcid" /> 
     <br><br>
