...
<center><h2 style="color:darkgreen;">SHOWROOM INFORMATION STORAGE</h2></center>
...
echo "<script type='text/javascript'>alert('$msg');</script>";
    ...
    <h1 style="color:darkgreen;"><center>SHOWROOM UPDATION</center></h1>
    <form method="post">
 Enter the sid for updating<input type="text" name="sid" /> 
     <br><br>
Showroom name: <input type="text" name="sname" required /><br><br>
   ...
   $Saddress=$_POST['saddress'];
        ...
        $sql1="UPDATE footwear set sname='$Sname',saddress='$Saddress' where sid='$Sid' ";
...
$msg="1 record updated";
    ...
    <h1 style="color:darkgreen;"><center>SHOWROOM DELETION</center></h1>
    <form method="post">
        Enter the sid for deleting<input type="text" name="dsid" /> 
     <br><br>
 ...
 $sql2="DELETE FROM footwear WHERE sid='$dSid'";
